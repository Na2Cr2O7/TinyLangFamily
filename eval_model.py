...
def init_model(args):
    ...
    if args.load == 0:
        ...
        #     print(f'加载LORA模型: {args.lora_name}{os.path.abspath(f'./out/lora/lora_N_512.pth')}')
        #     apply_lora(model)
...
def get_prompt_datas(args):
    if args.model_mode == 0:
        ...
        if 'None' == 'None':
            ...
            # prompt_datas = lora_prompt_datas['None']
...
def main():
    ...
    parser.add_argument('--lora_name', default='Y', type=str)
